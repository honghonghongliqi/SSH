   ...
   <body class="body">
		...
		<div class="b">
			...
			<li>
				...
				<ul>
					<li>
						<a href="http://127.0.0.1:8081/LookPeopleAction" >查看用户信息</a>
					</li>
			...
			<li>
				<a href="http://127.0.0.1:8081/LookRecordAction">查看未还图书记录</a>
				<ul>
					<!--<li>
						<a href="" >借</a>
		        ...
		        <%
		          ...
		          for(int i=0;i<list.size();i++){
		            ...
		            <tr>
		              ...
		              <td><%=bPo.getPrice()%></td>
                        <td>
		                <a href="http://127.0.0.1:8081/user/borrowreturn/borrow.jsp?id=<%=bPo.getId()%>">借书</a>
                        </td>
		             </tr>
		             <%
		             }
