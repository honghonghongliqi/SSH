...
public class AddbookAction extends ActionSupport implements ServletResponseAware{
	...
	public void validate() {
		...
		if(this.getId()==null||this.getId().length()==0){
			...
			out.print("<script>window.location.href='http://127.0.0.1:8081/superAdmin/book1/addBook.jsp'</script>");
			out.flush();
			out.close();
		}else {
		...
		if (this.getName()==null||this.getName().length()==0) {
			...
			out.print("<script>window.location.href='http://127.0.0.1:80801/superAdmin/book1/addBook.jsp'</script>");
			out.flush();
			out.close();
		}
