...
<html>
  ...
  <body class="body">
            <div class="a"><p class="p">查看管理员</p></div>
		<div class="b">
			<nav>
			<ul>
		        ...
		        <%
		          ...
		          for(int i=0;i<list.size();i++){
		            ...
		            <tr>
		              ...
		              <td><%=aPo.getType()%></td>
		              <td><a href="http://127.0.0.1:8081/superAdmin/admin/changeAdmin.jsp?userName=<%=aPo.getUserName()%>">修改</a>
		              <a href="DeleteMessageAction1?id=<%=aPo.getId()%>" onClick="return confirm('确定删除?');">删除</a></td>
