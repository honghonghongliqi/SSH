...
import="java.util.ArrayList,com.study.entity.Book"%>
...
<html>
  <head>
   ...
   <body class="body">
            <div class="a"><p class="p">查看图书</p></div>
		<div class="b">
			<nav>
			<ul>
				<li>
		        ...
		        <%
		          ...
		          for(int i=0;i<list.size();i++){
		            ...
		            <tr>
		              ...
		              <td><%=bPo.getPlace()%></td>
		              <td><%=bPo.getPrice()%></td>
		              <td><a href="http://127.0.0.1:8081/superAdmin/book1/changeBook.jsp?id=<%=bPo.getId()%>">修改</a>
		              <a href="DeleteBookAction1?id=<%=bPo.getId()%>" onClick="return confirm('确定删除?');">删除</a>
		             </tr>
		             <%
		             }
		          }
